...
namespace extraflails.Armor.MeteorKnight.FireFlail
{
	class FieryFlail : ModProjectile
	{

		private const string ChainTexturePath = "extraflails/Armor/MeteorKnight/FireFlail/FieryChain";
		int ChainLength = 130;
		int MaxChainLength = 260;

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Fiery Flail"); // Set the projectile name to Example Flail Ball
		}
