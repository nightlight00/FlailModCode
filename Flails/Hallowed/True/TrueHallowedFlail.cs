...
namespace extraflails.Flails.Hallowed.True
{
    class TrueHallowedFlail : ModItem
    { 
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("True Crusader");
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<TrueHallowedFlailProjSpin>();
			item.shootSpeed = 0;
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<Flails.Hallowed.Normal.HallowedFlail>());
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			int yes = (damage / 2) * playerget.CrusaderDamageBuff;
			Projectile.NewProjectile(position.X, position.Y, speedX, speedY, type, yes, knockBack, player.whoAmI);
			return false;
		}
	}

	class TrueHallowedFlailProjSpin : FlailSpinner
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Crusader");
		}
		...
		public override void SetDefaults()
		{
			...
			TrueProjectile = ModContent.ProjectileType<TrueHallowedFlailProj>();
	...
	class TrueHallowedFlailProj : ModProjectile
	{
		private const string ChainTexturePath = "extraflails/Flails/Hallowed/True/TrueHallowedFlailChain";
		int ChainLength = 300;
		int MaxChainLength = 400;

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("True Crusader"); // Set the projectile name to Example Flail Ball
		}
