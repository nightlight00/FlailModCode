...
namespace extraflails.Flails.Hallowed.Normal
{
    class HallowedFlail : ModItem
    {
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<HallowedFlailProjSpin>();
			item.shootSpeed = 0;
	...
	class HallowedFlailProjSpin : FlailSpinner
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Crusader");
		...
		public override void SetDefaults()
		{
			...
			TrueProjectile = ModContent.ProjectileType<HallowedFlailProj>();
	...
	class HallowedFlailProj : ModProjectile
	{
		private const string ChainTexturePath = "extraflails/Flails/Hallowed/Normal/HallowedFlailChain";
		int ChainLength = 280;
		int MaxChainLength = 360;

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Crusader"); // Set the projectile name to Example Flail Ball
		}
