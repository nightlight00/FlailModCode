...
namespace extraflails.Flails.Space.StarEyeFlail
{
    class StarEyeFlail : ModItem
    {
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Star Eye");
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<StarEyeFlailProjSpin>();
			item.shootSpeed = 0;
	...
	class StarEyeFlailProjSpin : FlailSpinner
	{
		...
		public override void SetDefaults()
		{
			...
			TrueProjectile = ModContent.ProjectileType<StarEyeFlailProj>();
        ...
        public override void BuffHelper()
        {
			...
			if (!playerget.StarfallCooldown)
            {
				player.AddBuff(ModContent.BuffType<Buffs.Starfall.StarfallBuff>(), 1, false);
			}
		}

    }

	class StarEyeFlailProj : ModProjectile
	{
		private const string ChainTexturePath = "extraflails/Flails/Space/StarEyeFlail/StarEyeFlailChain";
		float starcooldown = 0;
		float starcooldown2 = 12;
		int ChainLength = 170;
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            if (starcooldown <= 0)
            {
				...
				num12 *= num14;
				num13 *= num14;
				int num15 = Projectile.NewProjectile(x, y, num12, num13, ProjectileID.Starfury, damage / 2 , 5f, 0, 0f, 0f);
				Main.projectile[num15].ai[1] = target.position.Y;
				starcooldown = starcooldown2;
            }
        }
