...
namespace extraflails.Flails.Space.Wyvern
{
	class WyvernFlail : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Flyal");
			Tooltip.SetDefault("Infused with the wyverns essence");
		}
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<WyvernFlailProjSpin>();
			item.shootSpeed = 0;
	...
	class WyvernFlailProjSpin : FlailSpinner
	{
		...
		public override void SetDefaults()
		{
			...
			TrueProjectile = ModContent.ProjectileType<WyvernFlailProj>();

			BonusGiven = ModContent.BuffType<Buffs.Flight.FlightBuff>();
		}
	...
	class WyvernFlailProj : ModProjectile
	{
		private const string ChainTexturePath = "extraflails/Flails/Space/Wyvern/WyvernFlailChain";
		int ChainLength = 200;
		int MaxChainLength = 300;

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Flyal"); // Set the projectile name to Example Flail Ball
		}
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
			...
			num12 *= num14;
			num13 *= num14;
			int num15 = Projectile.NewProjectile(x, y, num12, num13, ModContent.ProjectileType<WyvernFeather.WyvernFeather>(), (damage / 5) * 3, 5f, 0, 0f, 0f);
