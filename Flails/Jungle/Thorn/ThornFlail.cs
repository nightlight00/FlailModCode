...
namespace extraflails.Flails.Jungle.Thorn
{
    class ThornFlail : ModItem
    {

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Thorny Flail");
        ...
        public override void SetDefaults()
        {
			...
			item.shoot = ModContent.ProjectileType<ThornFlailProjSpin>();
			item.shootSpeed = 0;
		...
		public override void AddRecipes()
		{
			...
			recipe0.AddIngredient(ItemID.Chain, 3);
			recipe0.AddIngredient(ItemID.JungleSpores, 6);
			recipe0.AddIngredient(ItemID.Stinger, 9);
	...
	class ThornFlailProjSpin : FlailSpinner
	{
		...
		public override void SetDefaults()
		{
			...
			TrueProjectile = ModContent.ProjectileType<ThornFlailProj>();
		}
        ...
        public override void PostAI()
        {
			...
			{
				Dust dust = Dust.NewDustDirect(dustVector1 - new Vector2(5f), 10, 10, DustID.Grass, player.velocity.X, player.velocity.Y, 150);
	...
	class ThornFlailProj : ModProjectile
    {
		private const string ChainTexturePath = "extraflails/Flails/Jungle/Thorn/ThornFlailChain";
		int ChainLength = 160;
		int MaxChainLength = 240;

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Thorn Flail"); // Set the projectile name to Example Flail Ball
		}
        ...
        public override void AI()
		{
			...
			var dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, DustID.Grass, projectile.velocity.X * 0.4f, projectile.velocity.Y * 0.4f, 100, default, 1.5f);
			dust.noGravity = true;
			dust.velocity /= 2f;
