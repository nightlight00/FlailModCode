...
namespace extraflails.Flails.Dungeon.BallAndChain
{

	class BallAndChain : ModItem
	{

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Ball & Chain");
			Tooltip.SetDefault("Summons rings of bones as you spin it");
		}
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<BallAndChainProjSpin>();
			item.shootSpeed = 0;
	...
	// old shootspeed = 15
	class BallAndChainProjSpin : FlailSpinner
    {
		public override void SetStaticDefaults()
        {
        ...
        public override void SetDefaults()
        {
			...
			TrueProjectile = ModContent.ProjectileType<BallAndChainProj>();

			BonusGiven = ModContent.BuffType<Buffs.BallandChain.BallChainBuff>();
			BonusReset = 25f;
        }
	...
	class BallAndChainProj : ModProjectile
	{
		private const string ChainTexturePath = "extraflails/Flails/Dungeon/BallAndChain/BallAndChainChain";
		int ChainLength = 200;
