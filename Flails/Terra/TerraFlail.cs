...
namespace extraflails.Flails.Terra
{
    class TerraFlail : ModItem
    {
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Final Striker");
			Tooltip.SetDefault("Your weapon, my liege");
		}
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<TerraFlailProjSpin>();
			item.shootSpeed = 0;
		...
		public override void AddRecipes()
		{
			...
			recipe1.AddIngredient(ModContent.ItemType<Nights.True.TrueInfectiousTerrorFlail>());
			recipe1.AddIngredient(ModContent.ItemType<Hallowed.True.TrueHallowedFlail>());
			recipe1.AddIngredient(ModContent.ItemType<Broken.BrokenHeroFlail>());
	...
	class TerraFlailProjSpin : FlailSpinner
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Final Striker");
		...
		public override void SetDefaults()
		{
			...
			TrueProjectile = ModContent.ProjectileType<TerraFlailProj>();;
		}
	...
	class TerraFlailProj : ModProjectile
	{
		private const string ChainTexturePath = "extraflails/Flails/Terra/TerraFlailChain";
		int ChainLength = 300;
		...
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Final Striker"); // Set the projectile name to Example Flail Ball
		}
		...
		public override void AI()
		{
			...
			if (shootspeed == 0)
            {
				...
				shootVel.Normalize();
				shootVel *= 7f;
				Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, shootVel.X, shootVel.Y, ModContent.ProjectileType<TerraFlailExtraProj>(), (projectile.damage / 7) * 3, projectile.knockBack, Main.myPlayer, 0f, 0f);
				shootspeed = 13;
            }
			shootspeed -= 1;
		}
    ...
    class TerraFlailExtraProj : ModProjectile
    {
		float rotate = 10;

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Final Striker Spin"); // Set the projectile name to Example Flail Ball
		}
        ...
        {
			var dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, 107, projectile.velocity.X * 0.4f, projectile.velocity.Y * 0.4f, 100, default, 1.5f);
			dust.noGravity = true;
			dust.velocity /= 2f;
