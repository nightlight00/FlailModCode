...
namespace extraflails.Flails.HardmodeFlails.Palad
{
	class PalladFlail : ModItem
	{

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Palladium Lantern");
		}
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<PalladFlailProjSpin>();
			item.shootSpeed = 0;
	...
	class PalladFlailProjSpin : FlailSpinner
	{
		...
		public override void SetDefaults()
		{
			...
			TrueProjectile = ModContent.ProjectileType<PalladFlailProj>();
		}

		public override void PostAI()
		{
			Player player = Main.player[projectile.owner];
			player.AddBuff(BuffID.Inferno, 1, true);
			...
			{
				Dust dust = Dust.NewDustDirect(dustVector1 - new Vector2(5f), 15, 15, DustID.Fire, player.velocity.X, player.velocity.Y, 150);
	...
	class PalladFlailProj : ModProjectile
	{
		private const string ChainTexturePath = "extraflails/Flails/HardmodeFlails/Palad/PalladFlailChain";
		int ChainLength = 240;
		int MaxChainLength = 300;

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Pallad Lantern"); // Set the projectile name to Example Flail Ball
		}
