...
namespace extraflails.Flails.HardmodeFlails.Orichal
{
	class BlossomFlail : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<BlossomFlailProjSpin>();
			item.shootSpeed = 0;
	...
	class BlossomFlailProjSpin : FlailSpinner
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Cherry Blossom");
		...
		public override void SetDefaults()
		{
			...
			TrueProjectile = ModContent.ProjectileType<BlossomFlailProj>();
		}
	...
	class BlossomFlailProj : ModProjectile
	{
		float shootCooldown = 20;

		private const string ChainTexturePath = "extraflails/Flails/HardmodeFlails/Orichal/BlossomFlailChain";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Scattershot Head"); // Set the projectile name to Example Flail Ball
		}
		...
		public override void AI()
		{
			...
			if (shootCooldown == 0)
            {
				...
				for (int i = 0; i < numberProjectiles; i++)
				{
					...
					Projectile.NewProjectile(projectile.position.X, projectile.position.Y, perturbedSpeed.X, perturbedSpeed.Y,  ModContent.ProjectileType<BlossomFlower>(), projectile.damage / 2, 0f, player.whoAmI);
				}
				shootCooldown = 20;
            }
			shootCooldown--;
    ...
    class BlossomFlower : ModProjectile
    {
