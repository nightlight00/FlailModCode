...
namespace extraflails.Flails.HardmodeFlails.Mythril
{
    class ScattershotFlail : ModItem
    {
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<ScattershotFlailProjSpin>();
			item.shootSpeed = 0;
	...
	class ScattershotFlailProjSpin : FlailSpinner
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Scattershot");
		...
		public override void SetDefaults()
		{
			...
			TrueProjectile = ModContent.ProjectileType<ScattershotFlailProj>();
		}
	...
	class ScattershotFlailProj : ModProjectile
	{
		float shootCooldown = 20;

		private const string ChainTexturePath = "extraflails/Flails/HardmodeFlails/Mythril/ScattershotFlailChain";
		...
		public override void SetDefaults()
		{
			...
			projectile.friendly = true;
			projectile.penetrate = 3; // Make the flail infinitely penetrate like other flails
			projectile.melee = true;
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			if (projectile.penetrate == 1)
			{
				...
				int numberProjectiles = 7 + Main.rand.Next(5); // 7 to 12 shots
				for (int i = 0; i < numberProjectiles; i++)
				{
					...
					Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, perturbedSpeed.X, perturbedSpeed.Y, ModContent.ProjectileType<Scattershot>(), projectile.damage / 6, projectile.knockBack, Main.myPlayer, 0f, 0f);
				}
	...
	class Scattershot : ModProjectile
	{
		public override void SetDefaults()
		{
