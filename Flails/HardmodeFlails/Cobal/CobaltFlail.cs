...
namespace extraflails.Flails.HardmodeFlails.Cobal
{
	class CobaltFlail : ModItem
	{

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Cobalt Lantern");
		}
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<CobaltFlailProjSpin>();
			item.shootSpeed = 0;
	...
	class CobaltFlailProjSpin : FlailSpinner
	{
		...
		public override void SetDefaults()
		{
			...
			TrueProjectile = ModContent.ProjectileType<CobaltFlailProj>();
		}
	...
	class CobaltFlailProj : ModProjectile
	{
		private const string ChainTexturePath = "extraflails/Flails/HardmodeFlails/Cobal/CobaltFlailChain";
		int ChainLength = 240;
