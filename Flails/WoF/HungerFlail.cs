...
namespace extraflails.Flails.WoF
{
    class HungerFlail : ModItem
    {
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Starvation");
		}
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<HungerFlailProj>();
			item.shootSpeed = 15;
	...
	class HungerFlailProj : ModProjectile
	{
		private const string ChainTexturePath = "extraflails/Flails/WoF/HungerFlailChain";
		int ChainLength = 250;
		int MaxChainLength = 325;

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Starvation"); // Set the projectile name to Example Flail Ball
		}
	...
	//			Projectile.NewProjectile(projectile.position.X, projectile.position.Y, perturbedSpeed.X, perturbedSpeed.Y, ProjectileID.VampireHeal, 2, 0, projectile.whoAmI);
			}
        }
