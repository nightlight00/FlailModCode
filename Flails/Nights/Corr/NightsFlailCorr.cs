...
namespace extraflails.Flails.Nights.Corr
{

	class NightsFlailCorr : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<NightsFlailCorrProj>();
			item.shootSpeed = 17;
	...
	class NightsFlailCorrProj : ModProjectile
	{
		private const string ChainTexturePath = "extraflails/Flails/Nights/Corr/NightsFlailCorrChain";
