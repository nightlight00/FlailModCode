...
namespace extraflails.Flails.Nights.Normal
{

	class InfectiousTerrorFlail : ModItem
	{

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Infectious Terror");
		}
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<InfectiousTerrorFlailProjSpin>();
			item.shootSpeed = 0;
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<Flails.Jungle.Thorn.ThornFlail>());
			recipe.AddIngredient(ItemID.Sunfury);
			recipe.AddTile(TileID.DemonAltar);
			recipe.SetResult(this);
			recipe.AddRecipe();

			var recipe0 = new ModRecipe(mod);
			recipe0.AddIngredient(ItemID.TheMeatball);
			recipe0.AddIngredient(ItemID.BlueMoon);
			recipe0.AddIngredient(ModContent.ItemType<Flails.Jungle.Thorn.ThornFlail>());
			recipe0.AddIngredient(ItemID.Sunfury);
		...
		class InfectiousTerrorFlailProjSpin : FlailSpinner
		{
			public override void SetStaticDefaults()
			{
			...
			public override void SetDefaults()
			{
				...
				TrueProjectile = ModContent.ProjectileType<InfectiousTerrorFlailProj>();
			}
		...
		class InfectiousTerrorFlailProj : ModProjectile
		{
			private const string ChainTexturePath = "extraflails/Flails/Nights/Normal/InfectiousTerrorFlailChain";
			float gothrough = 10;
			public override void SetStaticDefaults()
			{
				DisplayName.SetDefault("Terror"); // Set the projectile name to Example Flail Ball
			}
			...
			{
				var dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, 14, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.4f, 100, default, 2f);
				dust.noGravity = true;
				dust.velocity /= 2f;
