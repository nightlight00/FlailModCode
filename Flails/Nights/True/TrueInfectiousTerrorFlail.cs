...
namespace extraflails.Flails.Nights.True
{

	class TrueInfectiousTerrorFlail : ModItem
	{

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("True Infectious Terror");
		}
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<TrueInfectiousTerrorFlailProjSpin>();
			item.shootSpeed = 0;
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<Normal.InfectiousTerrorFlail>());
		...
		class TrueInfectiousTerrorFlailProjSpin : FlailSpinner
		{
			public override void SetStaticDefaults()
			{
				DisplayName.SetDefault("True Terror");
			}
			...
			public override void SetDefaults()
			{
				...
				TrueProjectile = ModContent.ProjectileType<TrueInfectiousTerrorFlailProj>();
			}
		...
		class TrueInfectiousTerrorFlailProj : ModProjectile
		{
			private const string ChainTexturePath = "extraflails/Flails/Nights/True/TrueInfectiousTerrorFlailChain";
			float gothrough = 10;

			public override void SetStaticDefaults()
			{
				DisplayName.SetDefault("True Terror"); // Set the projectile name to Example Flail Ball
			}
