...
namespace extraflails.Flails.Nights.Crim
{ 

    class NightsFlailCrim : ModItem
    {

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Amalgam");
			Tooltip.SetDefault("This item is going to be deleted" +
							 "\nWhen you use it, you will be given its replacement");
		}
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<NightsFlailCrimProj>();
			item.shootSpeed = 17;
		...
		{
			player.QuickSpawnItem(ModContent.ItemType<Normal.InfectiousTerrorFlail>(), 1);
			return false;
		}
	}

	class NightsFlailCrimProj : ModProjectile
	{
		private const string ChainTexturePath = "extraflails/Flails/Nights/Crim/NightsFlailCrimChain";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Amalgam"); // Set the projectile name to Example Flail Ball
		}
		...
		{
			var dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, DustID.Fire, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.4f, 100, default, 2f);
			dust.noGravity = true;
			dust.velocity /= 2f;
