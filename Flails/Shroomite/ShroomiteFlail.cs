...
namespace extraflails.Flails.Shroomite
{
	class ShroomiteFlail : ModItem
	{

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Shroomite Warhead");
		}
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<ShroomiteFlailProjSpin>();
			item.shootSpeed = 0;
	...
	class ShroomiteFlailProjSpin : FlailSpinner
	{
		public override void SetStaticDefaults()
		{
		...
		public override void SetDefaults()
		{
			...
			TrueProjectile = ModContent.ProjectileType<ShroomiteFlailProj>();
		}
	...
	class ShroomiteFlailProj : ModProjectile
	{
		float gothrough = 10;
		
		private const string ChainTexturePath = "extraflails/Flails/Shroomite/ShroomiteFlailChain";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Shroomite Warhead"); // Set the projectile name to Example Flail Ball
		}
		...
		public override void SetDefaults()
		{
			...
			projectile.friendly = true;
			projectile.penetrate = 4; // Make the flail infinitely penetrate like other flails
			projectile.melee = true;
			projectile.tileCollide = false;
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            {
				Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0, 0, ModContent.ProjectileType<ShroomiteExplosion>(), projectile.damage * 3, projectile.knockBack, Main.myPlayer, 0f, 0f);
    ...
    class ShroomiteExplosion : ModProjectile 
	{
		public override void SetDefaults()
		{
        ...
        public override void AI()
        {
			float dustNumber = 7 + Main.rand.Next(3); // 8, 9, or 10 dust
			for (int i = 0; i < dustNumber; i++)
			{
				var dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, 31, projectile.velocity.X * 0.4f, projectile.velocity.Y * 0.4f, 100, default, 3f);
				dust.noGravity = true;
				dust.velocity /= 2f;
			}//31

			dustNumber = 5 + Main.rand.Next(9); // 8, 9, or 10 dust
			for (int i = 0; i < dustNumber; i++)
			{
				var dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, DustID.Fire, projectile.velocity.X * 0.4f, projectile.velocity.Y * 0.4f, 100, default, 3f);
				dust.noGravity = true;
				dust.velocity /= 2f;
			}
		}
