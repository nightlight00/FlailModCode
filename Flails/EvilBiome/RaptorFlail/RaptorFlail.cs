...
namespace extraflails.Flails.EvilBiome.RaptorFlail
{
	class RaptorFlail : ModItem
	{

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Scarlet Raptors");
			Tooltip.SetDefault("Thirsty for blood");
		}
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<RaptorFlailProj>();
			item.shootSpeed = 29;
	...
	class RaptorFlailProj : ModProjectile
	{
		private const string ChainTexturePath = "extraflails/Flails/EvilBiome/RaptorFlail/RaptorFlailChain";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Raptors"); // Set the projectile name to Example Flail Ball
		}
		...
		public override void AI()
		{
			...
			if (projectile.ai[0] == 0f)
			{
				...
				float maxChainLength = 180f * playerget.ChainLength;
			...
			else if (projectile.ai[0] == 1f)
			{
				...
				float maxStretchLength = 180f * playerget.ChainLength; // This is the furthest the flail can stretch before being forced to retract. Make sure that this is a bit less than maxChainLength so you don't accidentally reach maxStretchLength on the initial throw.
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			while (true)
			{
				...
				Color color = Lighting.GetColor((int)drawPosition.X / 12, (int)(drawPosition.Y / 16f));
