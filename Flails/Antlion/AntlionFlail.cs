...
namespace extraflails.Flails.Antlion
{
    class AntlionFlail : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<AntlionFlailProj>();
			item.shootSpeed = 15;
	...
	class AntlionFlailProj : ModProjectile
	{
		private const string ChainTexturePath = "extraflails/Flails/Antlion/AntlionFlailChain";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Antlion"); // Set the projectile name to Example Flail Ball
		}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			while (true)
			{
				...
				drawPosition += remainingVectorToPlayer * 6 / length;
