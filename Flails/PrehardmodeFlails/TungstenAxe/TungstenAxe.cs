...
namespace extraflails.Flails.PrehardmodeFlails.TungstenAxe
{
	class TungstenAxe : ModItem
	{

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Tungsten Spinner");
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<TungstenAxeProj>();
			item.shootSpeed = 14;
	...
	class TungstenAxeProj : ModProjectile
	{
		private const string ChainTexturePath = "extraflails/Flails/PrehardmodeFlails/TungstenAxe/TungstenAxeChain";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("SolarFury"); // Set the projectile name to Example Flail Ball
		}
		...
		public override void AI()
		{
			...
			if (projectile.ai[0] == 0f)
			{
				...
				float maxChainLength = 160f * playerget.ChainLength;
