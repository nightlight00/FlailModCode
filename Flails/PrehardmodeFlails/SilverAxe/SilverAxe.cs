...
namespace extraflails.Flails.PrehardmodeFlails.SilverAxe
{
	class SilverAxe : ModItem
	{

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Silver Spinner");
		...
		public override void SetDefaults()
		{
			...
			item.shoot = ModContent.ProjectileType<SilverAxeProj>();
			item.shootSpeed = 14;
	...
	class SilverAxeProj : ModProjectile
	{
		private const string ChainTexturePath = "extraflails/Flails/PrehardmodeFlails/SilverAxe/SilverAxeChain";
